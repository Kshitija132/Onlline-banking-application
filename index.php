...
<head>
   ...
   <link rel="shortcut icon" href="img/ch.jpg">
    </head>
...
<div class="index_container">
    <div class="slider">
    <div class="slideimg" >
    <img  src="img\sbi.jpg" style="height:50vh" >
        <img src="img\sbi.jpg" style="height:50vh">
        <img src="img\sbi.jpg" style="height:50vh">
        <img src="img\sbi.jpg" style="height:50vh">
        <img src="img\sbi.jpg" style="height:50vh">
...
<div class="news_events" style="height:150px" >
    <h4 style="font-size:20px">Tips | Updates | Events</h4><br>
        <ul>
            <p style="font-size:15px">Register before opening your account.<br>

                Feel free to contact us for any help.<br>
                To link your pan and adhar go to your branch.<br>
    ...
    <div style="height:160px" class="online_services">
